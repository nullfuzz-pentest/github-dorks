...
1. Elegí un dork de la lista según lo que estés buscando (por ejemplo, claves de AWS, tokens de Slack, credenciales de bases de datos).
2. Pegalo en la [búsqueda de código de GitHub](https://github.com/search) o adaptalo para usarlo con la [API de búsqueda de GitHub](https://docs.github.com/en/rest/search).
3. Podés acotar la búsqueda a una organización o repositorio específico agregando `org:nombre-org` o `repo:usuario/repo`.
